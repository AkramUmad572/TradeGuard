...
The project is designed to explore how quantitative signals, AI-assisted reasoning, and continuous feedback can be combined to improve surveillance in markets where labeled insider-trading data is limited.
## Tech Stack
